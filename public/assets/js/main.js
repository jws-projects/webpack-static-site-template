...
;// CONCATENATED MODULE: ./src/js/components/component.js
const component = () => {
  console.log("this is from component");
};
/* harmony default export */ var components_component = (component);
...
var ls_aspectratio = __webpack_require__(277);
...
;// CONCATENATED MODULE: ./src/js/util/lazyLoad.js
...
imagesloaded_default()(elm, { background: true }, callback);
